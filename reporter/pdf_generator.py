...
class PageNumCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.drawString(54, 30, "Generated by LexMesh Multi-Framework Engine v2.0 · © 2026 LexMesh. All rights reserved.")
...
def generate_compliance_pdf(report_json: dict, output_filepath: str = "Compliance_Report.pdf"):
    ...
    disc_text = (
        report_json.get('disclaimer', '')
        or "DISCLAIMER: This report was generated by LexMesh, an AI-powered compliance analysis engine. "
           "It is intended for informational and audit-readiness purposes only and does not constitute formal legal counsel."
    )
    disc_table = Table([[
        Paragraph(
            f"<b>STATUTORY DISCLAIMER & LIMITATION OF LIABILITY:</b><br/>"
            f"<i>{disc_text}</i><br/>"
            f"<font size='7' color='#8a9e8f'>© 2026 LexMesh Enterprise Compliance Engine · Confidential & Proprietary</font>",
            ParagraphStyle('D', parent=body_style, fontSize=7.5, leading=10.5, textColor=colors.HexColor("#64748B"))
        )
    ]], colWidths=[504])
